...
_Generated: 2026-09-25T06:36:41.641Z_
...
Workspace `mcp.json` _(folder: Retail_Demand_Forecasting_system)_

- **d:\Retail_Demand_Forecasting_system\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\ELCOT\AppData\Roaming\Code\User\mcp.json** — _File missing_
